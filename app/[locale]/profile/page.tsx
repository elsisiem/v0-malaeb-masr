      ...
      <main className="container p-4">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            ...
            <div className="flex items-center mt-1">
              ...
              <Badge variant="outline">{t("sports.tennis")}</Badge>
            </div>
          </div>
        ...
        <Tabs defaultValue="profile" value={activeTab} onValueChange={setActiveTab}>
          <TabsList className="grid grid-cols-3 mb-4">
            ...
            <TabsTrigger value="favorites">{t("profilePage.favorites")}</TabsTrigger>
          ...
          <TabsContent value="profile" className="space-y-4">
            ...
            <Card>
              <CardContent className="p-4">
                <h3 className="font-semibold mb-3">{t("profilePage.activityStats")}</h3>
                <div className="grid grid-cols-3 gap-2 text-center">
                  <div className="p-2 border rounded-md">
                    <div className="text-2xl font-bold">12</div>
                    <div className="text-xs text-muted-foreground">{t("profilePage.bookings")}</div>
                  </div>
                  <div className="p-2 border rounded-md">
                    <div className="text-2xl font-bold">3</div>
                    <div className="text-xs text-muted-foreground">{t("profilePage.teams")}</div>
                  </div>
                  <div className="p-2 border rounded-md">
                    <div className="text-2xl font-bold">8</div>
                    <div className="text-xs text-muted-foreground">{t("profilePage.venues")}</div>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-4">
                <h3 className="font-semibold mb-3">{t("profilePage.recentActivity")}</h3>
            ...
            <Card>
              <CardContent className="p-4">
                <div className="flex items-center justify-between mb-3">
                  <h3 className="font-semibold">{t("profilePage.paymentMethods")}</h3>
                  <Button variant="ghost" size="sm" className="text-primary">
                    {t("profilePage.addNew")}
                  </Button>
                </div>
                <div className="space-y-3">
                  <div className="flex items-center gap-3 p-3 border rounded-md">
                    ...
                    <Badge>{t("profilePage.default")}</Badge>
                  </div>
                </div>
              </CardContent>
            </Card>
                  ...
                  <div className="p-4">
                    <div className="flex items-start justify-between">
                      ...
                      <div className="text-right">
                        <div className="font-semibold">{t("common.egp")} 250</div>
                        <div className="text-xs text-muted-foreground">{t("common.perHour")}</div>
                      </div>
                    </div>
                ...
                <CardContent className="p-0">
                  ...
                  <div className="p-4">
                    <div className="flex items-start justify-between">
                      ...
                      <div className="text-right">
                        <div className="font-semibold">{t("common.egp")} 180</div>
                        <div className="text-xs text-muted-foreground">{t("common.perHour")}</div>
                      </div>
                    </div>
                    <Button className="w-full mt-4" size="sm">
          ...
          <TabsContent value="settings" className="space-y-4">
            ...
            <Card>
              <CardContent className="p-4">
                <h3 className="font-semibold mb-3">{t("profilePage.accountSettings")}</h3>
                <div className="space-y-4">
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <span>{t("profilePage.paymentMethods")}</span>
                    </div>
                    <ChevronRight className="h-4 w-4 text-muted-foreground" />
                  </Link>
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <span>{t("profilePage.security")}</span>
                    </div>
                    <ChevronRight className="h-4 w-4 text-muted-foreground" />
                  </Link>
                </div>
            ...
            <Card>
              <CardContent className="p-4">
                <h3 className="font-semibold mb-3">{t("profilePage.preferences")}</h3>
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      <Bell className="h-4 w-4 mr-3" />
                      <span>{t("profilePage.notifications")}</span>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      <span>{t("profilePage.darkMode")}</span>
                    </div>
                    <Switch
                      id="dark-mode"
                  ...
                  <div className="flex items-center justify-between p-2 hover:bg-muted rounded-md">
                    <div className="flex items-center">
                      ...
                      <span>{t("profilePage.language")}</span>
                    </div>
                    <LanguageSwitcher />
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <Link href="/share" className="flex items-center justify-between p-2 hover:bg-muted rounded-md">
                    <div className="flex items-center">
                      ...
                      <span>{t("profilePage.shareApp")}</span>
                    </div>
                    <ChevronRight className="h-4 w-4 text-muted-foreground" />
                  </Link>
                </div>
